...
public class Chip : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        resourceConsumption = _setting.ResourceConsumption;
    ...
    public Resource resourceConsumption { get; private set; }

    public Target target { get; private set; }

    // その他にもProcessCountやチップにかかっている効果などの動的な状態を追加

    public void SetAvailability(Availability newAva)
    {
        availability = newAva;
    }

    public void SetMobility(Mobility newMob)
    {
        mobility = newMob;
    }

    public void SetTiming(Timing newTim)
    {
        timing = newTim;
    }
    ...
    public void SetResourceConsumption(Resource newRC)
    {
        resourceConsumption = newRC;
    }

    public void SetTarget(Target newTar)
    {
        target = newTar;
    }
